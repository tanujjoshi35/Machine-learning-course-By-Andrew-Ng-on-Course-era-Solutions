...
temp1=(lambda/m)*[zeros(size(Theta1,1),1),Theta1(:,2:end)]; %25x401
temp2=(lambda/m)*[zeros(size(Theta2,1),1),Theta2(:,2:end)]; %10x26

Theta1_grad=delta_1 + temp1;
Theta2_grad=delta_2 + temp2;
